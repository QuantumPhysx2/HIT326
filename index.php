  ...
  <body id="homePage">
    <header>
      <div class="admin-options">
        <ul>
          <a href="pages/register.php"><i class="fa fa-user-circle" title="Login"></i></a>
      ...
      <div class="bottom-header">
        <ul class="navigation">
          ...
          <li><a href="pages/product.php">Main Products</a></li>
      ...
      <div class="mobile-nav">
        <a href="index.php" id="active"><i class="fa fa-home"></i></a>
        <a href="pages/product.php"><i class="fa fa-dollar"></i></a>
    ...
    <main>
      ...
      <div class="container">
        <h1 class="key-header">Australia's Most Demanded Products</h1>
        <div class="wrapper">
          <!-- PLACE PLACEHOLDER CONTENT HERE -->
          <section>
